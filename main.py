...
with open('token.txt') as Course_work: # В файле записан токен для ВК
    vk_token = Course_work.readline().strip()

def user_id():
    '''Получение id пользователя, чьи фотографии хотим загрузить на Я.Диск.'''
...
class VK:
    ...
    def all_photos(self, count=5):
        ...
        self.count = count # По условию задачи - 5
...
class Yandex:
    ...
    def create_new_folder(self, folder_name='Курсовая PY-64'):
